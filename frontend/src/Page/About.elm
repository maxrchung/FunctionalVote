...
view =
  div [] 
    ...
    , div [ class "fv-main-text pb-6" ]
      [ text "-- Ranked-choice voting is objectively more fair than traditional voting because preferential ranking is much more flexible than a single vote cast in stone. Voters are incentivized to vote for their personal favorite options rather than try and vote for a popular choice that they think will win." ]
